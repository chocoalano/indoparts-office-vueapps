<template>
    <v-data-table v-if="$can('read-role')" :headers="headers" :items="desserts" :options.sync="options" :server-items-length="totalDesserts"
        ...
        <template v-slot:top>
            <v-toolbar flat>
                ...
                <v-btn small outlined fab color="danger" @click="deletebatch" v-if="$can('delete-role')">
                ...
                <v-dialog v-model="dialog" max-width="500px">
                    <template v-slot:activator="{ on, attrs }">
                        <v-btn small outlined fab color="primary" class="mb-2" v-bind="attrs" v-on="on" v-if="$can('create-role')">
                ...
                <v-dialog v-model="dialogDelete" max-width="500px" v-if="$can('delete-role')">
                    <v-card>
